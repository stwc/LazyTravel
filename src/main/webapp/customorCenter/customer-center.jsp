    ...
    <div class="row my-3 d-flex justify-content-around">
      <div class="col-md-4 mb-3">
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <input type="text" readonly class="form-control-plaintext" id="staticName" value="<%= customer.getCustomerName() %>">
          </div>
        </div>
        <div class="row">
          <label for="staticNickname" class="col-sm-4 col-form-label">暱稱</label>
          <div class="col-sm-8">
            <input type="text" readonly class="form-control-plaintext" id="staticNickname" value="<%= customer.getNickname() %>">
          </div>
        </div>
        <div class="row">
          <label for="staticNickname" class="col-sm-4 col-form-label">Email</label>
          <div class="col-sm-8">
            <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<%= customer.getEmail() %>">
          </div>
        </div>
      </div>
      <div class="col-md-6">
        ...
        <ul class="nav flex-column mt-3">
          <li class="nav-item mb-2"><a href="customer-modify.jsp" class="nav-link p-0 text-muted">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
              </svg> 修改會員資料</a>
          </li>
          <li class="nav-item mb-2"><a href="customer-resetpw.jsp" class="nav-link p-0 text-muted">
