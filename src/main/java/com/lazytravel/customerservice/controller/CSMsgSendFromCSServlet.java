...
@WebServlet(name = "CSMsgSendFromCSServlet",value = "/customerService/customerServiceSendMsg")
public class CSMsgSendFromCSServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        Integer customerId = csMessage.getCustomerId();
        System.out.println("get csMessage from CSMessage:"+customerId);
        
        
        csMessage.setMessageFrom(CSMessageFrom.CUSTOMER_SERVICE_STAFF.getMessageFrom());
