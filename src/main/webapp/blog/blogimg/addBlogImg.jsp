...
<head>
	...
	<title>文章新增 - addBlogImg.jsp</title>
...
<table id="table-1">
	<tr><td>
		<h3>文章新增 - addBlogImg.jsp</h3></td><td>
...
<FORM METHOD="post" ACTION="blogImg.do" name="form1" enctype="multipart/form-data">
	<table>
		<tr>
			<td>文章ID:</td>
			<td><input  type="TEXT" name="blog_id" value="<%= (blogImg == null)? "41002" : blogImg.getBlog().getBlogId()  %>" size="45"/></td>
		</tr>
		<tr>
			<td>上傳時間:</td>
			<td><input type="TEXT" name="createTime" value="<%=(blogImg ==null)? new java.sql.Timestamp(System.currentTimeMillis()) : blogImg.getCreateTime()%>" size="45"/></td>
		</tr>
		<tr>
			<td>內文圖片:</td>
