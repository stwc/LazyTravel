...
<!--     <div id="header"></div> -->
    ...
    <main id="main">
        ...
        <p style="font-size: 20px;"><b>修改旅行團</b></p>
        <br>    
		...
		<form method="post" action="<%=request.getContextPath()%>/journey/admin/tourGroup.do">
	        <div class="div_groupId">
	            <label>旅行團ID :</label>
	            <div><%= (tourGroup == null) ? "" : tourGroup.getGroupId() %></div>
	        </div>
	        <br>
	        ...
	        <div class="div_price">
	            <label>價格 :</label>
	            <input type="number" name="price" value="<%= (tourGroup == null) ? "0" : tourGroup.getPrice() %>" min="1">
	        </div>
	
	        <div class="div_requiredMin">
	            <label>成團人數 :</label>
	            <input type="number" name="min_required" value="<%= (tourGroup == null) ? "0" : tourGroup.getMinRequired() %>" min="1">
	        </div>
	
	        <div class="div_requiredMax">
	            <label>報名人數上限 :</label>
	            <input type="number" name="max_required" value="<%= (tourGroup == null) ? "0" : tourGroup.getMaxRequired() %>" min="1">
	        </div>
	        ...
	        <!-- 下面欄位不能透過後台修改資料 -->
	        <input type="hidden" name="sign_num" value="<%= tourGroup.getSignupNum() %>">
	        ...
	        <br>
	        <div class="div_btn">
				<button type="submit" name="tourGroup_update" class="btn_submit">送出</button>
				<input type="hidden" name="group_id" value="<%=tourGroup.getGroupId()%>">
				<input type="hidden" name="action" value="tourGroup_update">
