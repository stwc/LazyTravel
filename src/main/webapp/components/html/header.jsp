          ...
          <div class="navbar nav-item-area">
            <ul class="navbar-nav d-flex flex-row">
              ...
              <li class="nav-item dropdown mx-4">
                ...
                <ul class="dropdown-menu" style="position: absolute">
                  <li><a class="dropdown-item" href="<%=request.getContextPath()%>/customerCenter/customer-center.jsp">會員資料</a></li>
              ...
              <li class="nav-item mx-4"><a class="nav-link" href="<%=request.getContextPath()%>/customer/login.jsp"
