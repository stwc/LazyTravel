                ...
                <c:forEach var="blog" items="${searchResults}">
	                ...
	                <img class="card-img-top" src="<%=request.getContextPath()%>/blog/blog/BlogImgReader?blogId=${blog.blogId}" style=" width: 100%; height: 50%;" />
	                    <div class="card-body p">
	                        ...
	                        <input type="submit" name="action" value="看更多" action="getOne_For_Display" class="btn btn-primary m-1 p-1" style="background: #9C6644;border-color: transparent;color: white;width: 100px;height: 30px">
	                    </div>
	                    		</div>
	                </div>
	            </div>
