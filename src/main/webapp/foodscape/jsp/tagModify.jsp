...
<body>
  ...
  <div class="container">
    <form method="post" action="user.do" class="row m-3 p-3">
      <h2 class="mb-4">修改標籤</h2>
      <div class="col-12 mb-3">
        <label for="staticId" class="col-md-6 col-form-label">標籤ID</label>
        <input type="text" readonly class="form-control-plaintext" id="staticId" value="1">
      </div>
      <div class="col-md-12 mb-3">
        <label for="InputName" class="form-label">標籤名稱</label>
        <input type="text" name="username" class="form-control" id="InputName" required>
      </div>
      <div class="col-12 mb-3">
        <label for="FormControlTextarea1" class="form-label">更新時間</label>
