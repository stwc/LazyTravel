...
INSERT INTO CS_MAIL (CUSTOMER_ID, TITLE, CS_MAIL_STATUS) VALUES (1001, '想問行程的問題', '0');
INSERT INTO CS_MAIL (CUSTOMER_ID, TITLE, CS_MAIL_STATUS) VALUES (1002, '我想取消訂單', '0');
...
INSERT INTO CS_MESSAGE (MAIL_ID, CONTENT, MESSAGE_FROM) VALUES (1, '請問連假有加開行程嗎？', '0');
INSERT INTO CS_MESSAGE (MAIL_ID, CONTENT, MESSAGE_FROM) VALUES (2, '我想取消這筆訂單，訂單編號是XXX', '0');
...
INSERT INTO CS_IMG (MESSAGE_ID) VALUES (1), (2);
...
INSERT INTO OPENTIME(FOODSCAPE_ID, START_TIME, END_TIME, OPENTIME_WEEK) VALUES (1, '8:00', '15:00', 3), (2, '12:00', '21:00', 4);
...
INSERT INTO FOODSCAPE_IMG(FOODSCAPE_ID) VALUES (1), (2);
...
INSERT INTO FOODSCAPE_TAG(TAG_ID, FOODSCAPE_ID) VALUES (1, 1), (2, 2);
...
CREATE TABLE JOURNEY (
	...
	CREATE_TIME     DATETIME DEFAULT CURRENT_TIMESTAMP,
	CONTENT         LONGTEXT,
	AVG_SCORE       DOUBLE(3, 1) DEFAULT 0,
...
(1, 1, '2023-09-28 10:00:00', '2023-09-29 12:00:00', 1),
(1, 2, '2023-09-28 14:00:00', '2023-09-29 17:00:00', 1),
(1, 3, '2023-09-29 12:30:00', '2023-09-29 17:30:00', 2);
...
(1, '2023-09-28', '2023-09-28', 2000, 20, 15, 30, '2023-09-08 10:00:00', '2023-09-20 20:00:00'),
(1, '2023-09-30', '2023-10-02', 15000, 30, 20, 100, '2023-09-01 10:00:00', '2023-09-20 23:00:00');
...
INSERT INTO CUSTOMER_COUPON (CUSTOMER_ID, COUPON_ID) VALUES (1001, 1);
INSERT INTO CUSTOMER_COUPON (CUSTOMER_ID, COUPON_ID) VALUES (1002, 2);
...
INSERT INTO ORDERS (CUSTOMER_ID, GROUP_ID, TOTAL_AMT, ORDER_STATUS, CUSTOMER_POINT, COUPON_ID, TOURIST, ORDER_NO) VALUES (1001, 1, 3000, 0, 0, 1, 1, 2024110801);
INSERT INTO ORDERS (CUSTOMER_ID, GROUP_ID, TOTAL_AMT, ORDER_STATUS, CUSTOMER_POINT, COUPON_ID, TOURIST, ORDER_NO) VALUES (1002, 2, 6000, 1, 50, 2, 4, 2024110802);
...
INSERT INTO PASSENGER (ORDER_ID, IDNO, PASSENGER_NAME, PHONE, BIRTH) VALUES (1, "A123456789","王小民", "0912345678", "1911-01-01");
INSERT INTO PASSENGER (ORDER_ID, IDNO, PASSENGER_NAME, PHONE, BIRTH) VALUES (1, "A334433356","王二民", "0933542448", "1911-02-02");
INSERT INTO PASSENGER (ORDER_ID, IDNO, PASSENGER_NAME, PHONE, BIRTH) VALUES (2, "A334433356","王二民", "0933542448", "1911-02-02");
...
INSERT INTO BLOG (TITLE, CUSTOMER_ID, BLOG_DATE, CONTENT) VALUES ('中山區拉麵推薦', 1001, '2023-10-09', 'abc');
INSERT INTO BLOG (TITLE, CUSTOMER_ID, BLOG_DATE, CONTENT) VALUES ('台南必吃牛肉湯', 1002, '2023-08-12', 'xxx');
...
INSERT INTO FOODSCAPE_BLOG(FOODSCAPE_ID, BLOG_ID) VALUES (1, 1), (2, 2);
...
INSERT INTO BLOG_MSG (CONTENT, BLOG_ID, CUSTOMER_ID) VALUES ('hi', 1, 1002);
INSERT INTO BLOG_MSG (CONTENT, BLOG_ID, CUSTOMER_ID) VALUES ('hello', 1, 1002);
...
INSERT INTO BLOG_IMG (BLOG_ID) VALUES (1);
INSERT INTO BLOG_IMG (BLOG_ID) VALUES (2);
...
INSERT INTO BLOG_LIKE (CUSTOMER_ID, BLOG_ID) VALUES (1001, 1);
INSERT INTO BLOG_LIKE (CUSTOMER_ID, BLOG_ID) VALUES (1002, 1);
...
INSERT INTO BLOG_CL(CUSTOMER_ID, BLOG_ID) VALUES (1001, 1);
INSERT INTO BLOG_CL(CUSTOMER_ID, BLOG_ID) VALUES (1002, 2);
