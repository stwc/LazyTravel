...
import com.lazytravel.order.dao.OrdersService;
...
public class OrdersServlet extends HttpServlet{
	...
	private String getByOrderNo(HttpServletRequest req, HttpServletResponse res) {
	 ...
	 private String update(HttpServletRequest req, HttpServletResponse res) {
		...
		OrdersService ordersService = new OrdersService();
		order = ordersService.updateOrder(orderId, orderNo, customerId, groupId, tourist, customerPoint, couponId, totalAmt, orderStatus);
		order = ordersService.getOneOrder(orderId);
	 ...
	 private String insert(HttpServletRequest req,HttpServletResponse res) {
		...
		OrdersService ordersService = new OrdersService();
		order = ordersService.addOrder(orderNo, customerId, groupId, tourist, customerPoint, couponId, totalAmt, orderStatus );
